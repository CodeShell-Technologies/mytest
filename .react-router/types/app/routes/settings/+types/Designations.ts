...
import type { Info as Parent2 } from "./SettingsLayout.js"

type Module = typeof import("../Designations.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/settings/Designations"
  file: "routes/settings/Designations.tsx"
  path: "access-permission/designations"
