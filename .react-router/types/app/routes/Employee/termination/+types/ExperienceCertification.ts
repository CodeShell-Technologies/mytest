...
// routes/Employee/termination/ExperienceCertification.tsx
...
type Module = typeof import("../ExperienceCertification.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/Employee/termination/ExperienceCertification"
  file: "routes/Employee/termination/ExperienceCertification.tsx"
  path: "/View-certificate/:id/:resign_id"
  params: {"id": string; "resign_id": string} & { [key: string]: string | undefined }
  module: Module
