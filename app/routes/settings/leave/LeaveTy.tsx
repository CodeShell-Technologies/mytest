...
import CreateLanguageForm from "../language/CreateLanguageForm";
import EditLanguageForm from "../language/EditLanguageForm";
...
const LeaveTy = () => {
  ...
  const getSoftware = async (
    ...
    try {
      ...
      let url = `${BASE_URL}/master/leavetypes/read?branchcode=${branchCode}&page=${page}&limit=${limit}`;
  ...
  const handleCreateSuccess = () => {
    ...
    toast.success("Leave Type added successfully!", toastStyle);
    fetchBranches(token);
    getSoftware();
  };
  ...
  const handleDeleteSubmit = async () => {
    ...
    try {
      ...
      if (response?.status === 201) {
        ...
        toast.success("Leave deleted successfully!", toastStyle);
        fetchBranches(token);
        getSoftware();
      }
    } catch (error) {
  ...
  const tbody = () => {
    ...
    return data.map((software) => ({
      ...
      data: [
        ...
        { data: software.name },
         { data: software.year }, { data: software.total_days }, 
  ...
  const handleEditSuccess = () => {
    ...
    toast.success("Leave updated successfully!", toastStyle);
    fetchBranches(token);
    getSoftware();
  };
              ...
              >
                <div className="flex flex-col gap-6 justify-center items-center">
                  <p className="text-gray-500 text-lg font-bold text-center">
                    Are you sure you want to delete this Leavetype?
                  </p>
