...
// import EditUserRoleForm from "./EditInRoles";
...
//                 onClick={() => handleDeleteBranch(user.id)}
//                 title="Delete"
//               >
//                 <Trash2 size={18} />
//               </button>
