...
import CreateBranchForm from "~/routes/Branch/CreateBranchForm";
...
import CreateSalaryForm from "./AddSalary";
...
const SalaryList = () => {
  ...
  const handleDeleteBranch = (salary) => {
  ...
  const tbody = () => {
    ...
    return data.map((branch) => ({
      ...
      data: [
        ...
        { data: branch.basicsalary },
        { data: branch.hra },
        { data: branch.lpa },
        { data: branch.deductions },
        { data: branch.gross_salary },
        { data: branch.net_salary },
        { data: branch.bonus },
        { data: branch.processondate },
        ...
        <div className="flex flex-col gap-6 dark:bg-gray-800 bg-white p-6 rounded-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Are you sure you want to delete this Salary Details? This action
              cannot be undone.
            </p>
          </div>
          ...
          <div className="flex justify-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <ButtonLoader /> : "Delete Salary"}
            </button>
          </div>
        </div>
      </Modal>
