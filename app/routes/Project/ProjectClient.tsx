...
const clientCode = query.get("client_code"); // "02/CLNT/01"
  ...
  const getBranch = async (
    ...
    setLoading(true);
    try {
      let url = `${BASE_URL}/project/overview/read?page=${page}&limit=${limit}&client_code=${encodeURIComponent(clientCode)}`;
