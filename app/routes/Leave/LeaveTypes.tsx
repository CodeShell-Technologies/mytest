...
import CreateLeaveForm from "../settings/leave/CreateLeaveForm";
import EditLeaveForm from "../settings/leave/EditLeaveForm";
const LeaveTypes = () => {
...

        {
          data: (
            ...
            >
              ...
              ></span>
              {software.status.charAt(0).toUpperCase() +
                software.status.slice(1)}
            </div>
          ),
        },
        {
